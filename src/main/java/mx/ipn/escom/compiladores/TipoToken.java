...
public enum TipoToken {
    ...
    // Palabras reservadas
    Y, CLASE, ADEMAS, FALSO, PARA, FUN, SI, NULO, IMPRIMIR, RETORNAR, SUPER, ESTE, VERDADERO, VAR, MIENTRAS,

    // Caracteres
    PARENTESIS_DER, PARENTESIS_IZQ, LLAVE_DER, LLAVE_IZQ, COMA, PUNTO, PUNTO_COMA, GUION_MEDIO, MAS, ASTERISCO,
    BARRA_INCL, ADMIRACION, OP_DIFERENTE, IGUAL_QUE, OP_IGUAL_QUE, MENOR_QUE, OP_MENOR_IGUAL_QUE, MAYOR_QUE, OP_MAYOR_IGUAL_QUE,
